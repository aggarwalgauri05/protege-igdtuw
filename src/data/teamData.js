...
export const teamSections = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Ashima Kaushik", role: "Head Coordinator", image: "/team/Ashima Kaushik.jpg" },
      ...
      { name: "Angel Gautam", role: "Coordinator", image: "/team/Angel_Gauatm.jpg" },
      ...
      { name: "Sonakshi Jaiswal", role: "Coordinator", image: "/team/Sonakshi_Jaiswal.jpg" }
    ].sort((a, b) => getRolePriority(a.role) - getRolePriority(b.role))
  },
  {
    id: "media",
